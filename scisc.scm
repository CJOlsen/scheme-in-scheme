...
;; Documentation:  See The Structure and Interpretation of Computer Programs
;;                 Chapter 4: 
...
;; needs to be defined before apply is overwritten
...
(define printall (lambda (#!rest a)
		   (map display a)))


(define (apply-primitive-procedure proc args)
  (apply  ;; changed from apply-in-underlying-scheme
